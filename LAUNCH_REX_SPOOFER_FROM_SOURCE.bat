...
echo ============================================================
echo.
echo   REX TOKEN SPOOFER - LAUNCH FROM SOURCE
echo.
echo ============================================================
echo.
...
REM Set PYTHONPATH to include .rovodev
...
echo.
echo   Step 3: Starting RovoDev from source...
echo.
...
REM Run RovoDev from source - spoofer will auto-load
python rovodev\__main__.py serve 3000
