...
# ============================================================================
# REX UNLIMITED MEMORY MODELS
# ============================================================================

@dataclass
class ConversationSession:
    """Represents a RovoDev chat session"""
    session_id: str
...
class ConversationMessage:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # Don't include embedding in dict (too large)
...
class ConversationInsight:
    """Represents an extracted insight from conversation"""
    session_id: str
    content: str
    insight_type: Optional[str] = None  # decision, solution, pattern, preference
    context: Optional[str] = None
