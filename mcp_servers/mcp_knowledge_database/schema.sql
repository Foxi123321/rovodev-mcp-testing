...
-- Conversation sessions (RovoDev chat sessions)
...
-- Individual conversation messages with embeddings
...
-- Extracted insights and decisions from conversations
...
CREATE INDEX IF NOT EXISTS idx_conv_insights_session ON conversation_insights(session_id);
CREATE INDEX IF NOT EXISTS idx_conv_insights_type ON conversation_insights(insight_type);
