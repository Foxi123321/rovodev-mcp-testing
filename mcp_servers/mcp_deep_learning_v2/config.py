...
EMBEDDING_MODEL = os.getenv("EMBEDDING_MODEL", "nomic-embed-text")  # For vectors (fast, optimized for embeddings)
...
DB_PATH = Path(os.getenv("DEEP_LEARNING_DB_PATH", DATA_DIR / "knowledge.db"))
VECTOR_INDEX_PATH = Path(os.getenv("DEEP_LEARNING_VECTOR_PATH", DATA_DIR / "vectors.faiss"))
